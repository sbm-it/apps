...
false||(function(){ // this little trick will have all variables stay local
    ...
    h += '<p style="color:navy"><a href="http://sbm-it.github.io/apps" target="_blank"><img width="'+(sbmApps.iconWidth*2)+'" src="img/qrcode.png"></a><br>'
    ...
    h += '<a href="http://sbm-it.github.io/apps/AddIOSHomeScreen.html"><img width="'+(sbmApps.iconWidth*2)+'" src="img/apple.png"></a><br>'

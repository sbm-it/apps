...
false||(function(){ // this little trick will have all variables stay local
    ...
    h += '<p style="color:navy;display:block;margin-left:auto;margin-right:auto">'
    h += '<a href="http://sbm-it.github.io/apps/AddAndroidHomeScreen.html"><img width="'+(sbmApps.iconWidth)+'" src="img/android.png"></a>'
    h += '<a href="http://sbm-it.github.io/apps/AddIOSHomeScreen.html"><img width="'+(sbmApps.iconWidth)+'" src="img/apple.png"></a></p>'
    ...
    h += '<p style="color:navy"><img width="'+(sbmApps.iconWidth*2)+'" src="img/homeicon.png"></p>'
